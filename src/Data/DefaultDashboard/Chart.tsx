...
export const Widgets2ChartData = {
  series: [
    {
      name: 'Daily',
...
export const Widgets2ChartDataWidgets = {
  series: [
    {
      name: 'Daily',
      data: [2.15, 3, 1.5, 2, 2.4, 3, 2.4, 2.8, 1.5, 1.7, 3, 2.5, 3, 2, 2.15, 3, 1.1],
...
export const Widgets2ChartData2 = {
  series: [
    {
      name: 'Desktops',
...
export const Widgets2ChartData2Widgets = {
  series: [
    {
      name: 'Desktops',
      data: [210, 180, 650, 200, 600, 100, 800, 300, 500],
...
// Currency Chart //
export const CurrencyChartData = {
  series: [
    {
      name: 'Earning',
...
export const GrowthChartDataResponsive = {
  responsive: [
    {
      breakpoint: 992,
      options: {
