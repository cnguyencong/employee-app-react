...
const SidebarMenu = ({ setMainMenu, props, sidebartoogle, setNavActive, activeClass, width }: any) => {
  const { customizer }: any = useContext(CustomizerContext);
    ...
    <nav className="sidebar-main" id="sidebar-main">
      ...
      >
        <ul className="sidebar-links custom-scrollbar">
          ...
          <SidebarMenuItems setMainMenu={setMainMenu} sidebartoogle={sidebartoogle} setNavActive={setNavActive} activeClass={activeClass} />
        </ul>
      </div>
