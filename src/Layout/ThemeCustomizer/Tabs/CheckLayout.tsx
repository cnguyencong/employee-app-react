...
const CheckLayout = () => {
  const { addSidebarLayouts }: any = useContext(CustomizerContext);
  const history = useNavigate();
  const sidebarSettings: any = ConfigDB.data.settings.sidebar_setting || localStorage.getItem('sidebar_Settings');

  useEffect(() => {
    ConfigDB.data.settings.sidebar_setting = sidebarSettings;
  }, []);

  const handlePageLayputs = (type: any) => {
    let key: any = Object.keys(type).pop();
  ...
  return (
    <Fragment>
      <ul className='sidebar-type layout-grid layout-types'>
        ...
        <LI attrLI={{ dataattr: 'compact-sidebar', onClick: (e: any) => handlePageLayputs(classes[0]) }}>
        ...
        <LI
          attrLI={{ dataattr: 'modern-layout', onClick: (e: any) => handlePageLayputs(classes[2]) }}
        ...
        <LI
          attrLI={{ dataattr: 'material-layout', onClick: (e: any) => handlePageLayputs(classes[3]) }}
        ...
        <LI attrLI={{ dataattr: 'dark-sidebar', onClick: (e: any) => handlePageLayputs(classes[4]) }}>
          <div className='layout-img'>
            <Media src={paris} className='img-fluid' alt='' />
            <H6>Paris</H6>
          </div>
        </LI>
        <LI attrLI={{ dataattr: 'compact-wrap', onClick: (e: any) => handlePageLayputs(classes[5]) }}>
          <div className='layout-img'>
            <Media src={tokyo} className='img-fluid' alt='' />
            <H6>Tokyo</H6>
          </div>
        </LI>
        <LI attrLI={{ dataattr: 'color-sidebar', onClick: (e: any) => handlePageLayputs(classes[6]) }}>
          <div className='layout-img'>
            <Media src={madrid} className='img-fluid' alt='' />
            <H6>Madrid</H6>
          </div>
        </LI>
        <LI attrLI={{ dataattr: 'compact-small', onClick: (e: any) => handlePageLayputs(classes[7]) }}>
          <div className='layout-img'>
            <Media src={moscow} className='img-fluid' alt='' />
            <H6>Moscow</H6>
          </div>
        </LI>
        <LI attrLI={{ dataattr: 'compact-small', className: 'box-layout', onClick: (e: any) => handlePageLayputs(classes[8]) }}>
          <div className='layout-img'>
            <Media src={newyork} className='img-fluid' alt='' />
            <H6>New York</H6>
          </div>
        </LI>
        <LI attrLI={{ dataattr: 'enterprice-type', onClick: (e: any) => handlePageLayputs(classes[9]) }}>
          <div className='layout-img'>
            <Media src={singapore} className='img-fluid' alt='' />
            <H6>Singapore</H6>
          </div>
        </LI>
        <LI attrLI={{ dataattr: 'material-icon', onClick: (e: any) => handlePageLayputs(classes[10]) }}>
          <div className='layout-img'>
            <Media src={romo} className='img-fluid' alt='' />
            <H6>Rome</H6>
          </div>
        </LI>
        <LI attrLI={{ dataattr: 'advance-type', onClick: (e: any) => handlePageLayputs(classes[11]) }}>
          <div className='layout-img'>
        ...
        <LI
          attrLI={{ dataattr: 'default-body', className: 'only-body', onClick: (e: any) => handlePageLayputs(classes[1]) }}
          //
        >
          <div className='layout-img'>
