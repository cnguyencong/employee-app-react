...
const SidebarSettingsClass = () => {
    const { addSidebarSettings }: any = useContext(CustomizerContext)

    const handleSidebarSetting = (e: any, type: any) => {
        e.preventDefault();
    ...
    return (
        <Fragment>
            ...
            <UL attrUL={{ className: "sidebar-setting layout-grid flex-row" }}>
                <LI attrLI={{ className: "border-0 active", dataattr: "default-sidebar", onClick: (e: any) => handleSidebarSetting(e, "default-sidebar") }} >
                ...
                <LI attrLI={{ className: 'border-0', dataattr: "border-sidebar", onClick: (e: any) => handleSidebarSetting(e, "border-sidebar") }} >
                    <div className="header bg-light">
                        <ul>
                            <li></li><li></li><li></li>
                        </ul>
                ...
                <LI attrLI={{ className: 'border-0', dataaattr: "iconcolor-sidebar", onClick: (e: any) => handleSidebarSetting(e, "iconcolor-sidebar") }} >
                    <div className="header bg-light">
                        <ul>
                            <li></li>
                            <li></li>
