...
const SideBarIconType = () => {
  const { addSidebarIconType }: any = useContext(CustomizerContext);
  ...
  const handleSideBarIconType = (e: any, type: any) => {
    e.preventDefault();
      ...
      <UL attrUL={{ className: 'sidebar-type layout-grid flex-row' }}>
        <LI
          attrLI={{
            ...
            onClick: (e: any) => handleSideBarIconType(e, 'stroke-svg'),
          }}>
        ...
        <LI
          attrLI={{
            ...
            onClick: (e: any) => handleSideBarIconType(e, 'fill-svg'),
          }}>
          <div className='header bg-light'>
            <CommenUL />
          </div>
