        ...
        <Fragment>
            <table align="center" border={0} cellPadding="0" cellSpacing="0" width="100%" className="product">
                <tbody>
                    <tr>
                        <td align="center">
                            <table className="display-width-inner banner" style={{ textAlign: 'center' }} border={0} cellPadding="0" cellSpacing="0" width="100%" >
                                <tbody>
                                    <tr>
                                        <td align="center" >
                                        ...
                                        <td align="center" className="banner-title" >
                                            ...
                                            <div className='banner-price' >
                                                <span className="txt-price1" data-color="Price1" data-size="Price1" data-min="10" data-max="35">
                                                    <b>$25.00</b></span><span className="txt-price2">   </span>$20.90</div>
